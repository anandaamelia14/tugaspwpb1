...
class Auth extends CI_Controller
{
 ...
 private function _sendEmail($token, $type)
 {
     ...
     $this->email->from('pu89307@gmail.com', 'putri nanda');
...
public function changePassword()
{
    ...
    $this->from_validation->set_rules('password1','password','trim|required|min_length[3]|matchces[password2]');
    $this->from_validation->set_rules('password2','Repeat Password','trim|required|min_length[3]|matchces[password1]');
